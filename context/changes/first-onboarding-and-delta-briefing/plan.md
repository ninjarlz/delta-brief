...
- [x] 5.4 Generation spinner confirmed on all three trigger buttons — user-confirmed live in browser: button greys out, shows the spinning circle icon, label changes to "Generating…"
